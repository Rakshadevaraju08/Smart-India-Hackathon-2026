...
guide_text = """# SIH 2026: URBAN FLOOD NOWCASTING SYSTEM (DRAINAGE & RAINFALL COUPLING)
...
with open("SIH2026_Urban_Flood_Master_Guide.md", "w", encoding="utf-8") as f:
    f.write(guide_text)

print("Created SIH2026_Urban_Flood_Master_Guide.md successfully!")
