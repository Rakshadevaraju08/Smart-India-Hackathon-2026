...
Smart India Hackathon 2026 (PS #26085)
...
# Enable CORS for all origins so Web GIS frontend can connect from localhost, Vercel, or local file
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
def health_check() -> Dict[str, Any]:
    ...
    return {
        "status": "operational",
        "service": "KAIROS Layer 0 Rainfall Nowcasting Engine",
...
def get_nowcast(
    ...
    # Scale multiplier for moderate / convective
    ...
    # Extract street depths for horizons (t0, t30, t60, t90, t120, t180)
    col_map = {
        "t0": "d_T+15m_mm",
        "t30": "d_T+30m_mm",
        "t60": "d_T+60m_mm",
