...
Maps DEM surface elevation Z_ground, terrain slope S_0, aspect, and catchment
accumulation onto all 7,894 Greater Chennai Corporation road segments.
"""
...
class RoadElevationSampler:
    ...
    def __init__(self,
        ...
        self.datasets_dir = datasets_dir or (base_dir / "Datasets")
    ...
    def sample_roads(
        ...
        logger.info("Exported enriched road dataset to %s", out_csv)
        return df
